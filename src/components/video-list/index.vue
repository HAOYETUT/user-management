<template>
    <vxe-grid v-bind="gridOptions">
        <template #name_item="{ data }">
            <vxe-input v-model="data.name" type="text" placeholder="请输入视频名称"></vxe-input>
        </template>
...
export default {
    ...
    setup() {
        const gridOptions = reactive<VxeGridProps>({
              ...
              formConfig: {
                items: [
                  { field: 'name', title: '', itemRender: {}, slots: { default: 'name_item' } },
                  { field: 'sex', title: '', itemRender: {}, slots: { default: 'sex_item' } },
